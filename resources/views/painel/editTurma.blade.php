            ...
            <div class="input-box">
                <div class="flex-container">
                    <div class="input-form">
                        ...
                        <input id="cod_turma" name="cod_turma" type="text" placeholder="Código" value="{{$turma->cod_turma}}" required>
                    </div>
                    <div class="input-form">
                        <label for="semestre">Semestre</label><br>
                        <input id="semestre" name="semestre" type="text" placeholder="Semestre" value="{{$turma->semestre}}" required>
                    </div>
                </div>
                    ...
                    <div class="input-form">
                        ...
                        <select name="professores_id" id="professor" class="form-control">
                            ...
                            @foreach( $professores as $professor)
                                <option value="{{ $professor->id }}" {{ ( $turma->professores_id == $professor->id) ? 'selected' : '' }}>{{ $professor->nome }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
